...
public class MainApplication extends Application implements ReactApplication {
  ...
  public void onCreate() {
    ...
    ReactFontManager.getInstance().addCustomFont(this, "Noto Sans SC", R.font.noto_sans_sc);
    ReactFontManager.getInstance().addCustomFont(this, "Kantumruy Pro", R.font.kantumruypro);
